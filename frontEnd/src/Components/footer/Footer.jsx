      ...
      <div className='w-full max-w-7xl mx-auto' >
        <div className='grid w-full justify-between sm:flex md:grid-cols-1' >
            ...
            <div className='grid grid-cols-2 gap-3 sm:mt-4 sm:grid-cols-3 sm:gap-6' >
              ...
              <div className='flex flex-col aboutContainer' >
                <h1 className='text-sm md:text-xl font-bold text-gray-500 my-3' >A PROPOS</h1>
                <div className='flex flex-col gap-4 md:text-lg font-semibold text-gray-400' >
                  <span>
              ...
              <div className='flex flex-col followContainer' >
                <h1 className='text-sm md:text-xl font-bold text-gray-500 my-3' >NOUS SUIVREZ</h1>
                <div className='flex flex-col gap-4 md:text-lg font-semibold text-gray-400' >
                  <span>
                    <a href="https://github.com/Kabesa-abraham" target='_blank' 
              ...
              <div className='flex flex-col legalContainer' >
                <h1 className='text-sm md:text-xl font-bold text-gray-500 my-3' >LEGAL</h1>
                <div className='flex flex-col gap-4 md:text-lg font-semibold text-gray-400' >
                  <span>
       ...
       <hr className='my-5' />
        <div className='w-full sm:flex sm:items-center sm:justify-between' >
          <a href='#' className='text-gray-400 text-lg md:text-xl '>&#169; {new Date().getFullYear()} Abram's Blog  </a>
          <div className='flex gap-6 sm:gap-11 sm:mt-0 mt-4 text-3xl sm:justify-center text-gray-400' >
             <a href="https://facebook.com/Abraham Kabesa"><BsFacebook/></a>
             <a href="#"><BsInstagram/></a>
             <a href="https://www.linkedin.com/Abraham Yebula"><BsLinkedin/></a>
             <a href="https://github.com/Kabesa-abraham" target='_blank'><BsGithub/></a>
          </div>
        </div>
